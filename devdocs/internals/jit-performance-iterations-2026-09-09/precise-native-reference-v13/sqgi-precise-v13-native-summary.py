...
r=Path('/tmp/sqgi-precise-native-reference-study/profiles');out={}
...
assert out['recycle']['source_pin_stores']>0 and out['recycle']['cache_slot_loads']>0 and out['recycle']['fadd_instructions']==5
