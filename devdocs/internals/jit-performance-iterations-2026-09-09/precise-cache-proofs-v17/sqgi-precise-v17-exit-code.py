...
P=R/'devdocs/internals/jit-performance-iterations-2026-09-09/precise-native-store-v16/profiles'
D=Path('/tmp/sqgi-precise-cache-proof-study/profiles');result={}
