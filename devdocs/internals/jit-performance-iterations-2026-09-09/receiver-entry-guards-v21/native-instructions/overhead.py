...
R=Path('/home/sam/Programming/sqgi');D=Path('/tmp/sqgi-v21-native-profile');sys.path.insert(0,str(R/'tools'))
...
cmd=['taskset','-c','4',str(R/'build-jit-audit-20260909/receiver-entry-guards-v21/sqgi'),str(R/'test/bench_float_workloads.nut'),'--iterations=200000','--warmups=5']
rows=[];reference=None
for rnd in range(3):
