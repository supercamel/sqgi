...
P=R/'devdocs/internals/jit-performance-iterations-2026-09-09/closure-witness-guards-v19/profiles'
D=Path('/tmp/sqgi-receiver-entry-guard-study/profiles');result={}
