...
S=Path('/tmp/sqgi-transactional-float-copies-study');D=S/'route';D.mkdir(exist_ok=True)
(D/'symbols.json').write_bytes(Path('/home/sam/Programming/sqgi/devdocs/internals/jit-performance-iterations-2026-09-09/local-slot-forwarding-v22/route/symbols.json').read_bytes())
