...
import hashlib,json
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'transactional-float-copies-v23';B=R/'build-jit-audit-20260909/transactional-float-copies-v23'
