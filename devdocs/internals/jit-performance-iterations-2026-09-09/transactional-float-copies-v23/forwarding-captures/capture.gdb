...
out=pathlib.Path('/tmp/sqgi-transactional-float-copies-study/forwarding-captures');events=[];active={};installed={};finishes=[]
def readbuf(address):
...
commit=Commit('/home/sam/Programming/sqgi/Squirrel3/squirrel/jit/sqjit_backend_aarch64_emit.cpp:558',internal=True)
