...
out=pathlib.Path('/tmp/sqgi-transactional-float-copies-study/coverage-gaps');functions={};rejects=[];wanted=['rotate_buffers','object_member_write_fallback_kernel','members','event_records']
def name(p):
