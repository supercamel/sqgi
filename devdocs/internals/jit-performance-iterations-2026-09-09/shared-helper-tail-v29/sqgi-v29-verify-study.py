...
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'shared-helper-tail-v29';S=Path('/tmp/sqgi-shared-helper-tail-study')
h=lambda p:hashlib.sha256(p.read_bytes()).hexdigest()
binary=R/'build-jit-audit-20260909/shared-helper-tail-v29/sqgi';sha=h(binary)
assert sha=='24b4f8c1961001ffbad7a4735b998a912b87853f93bf71a10eab369a96ea9718'
...
assert code['rotate_buffers']['before_bytes']==7408 and code['rotate_buffers']['after_bytes']==7392
