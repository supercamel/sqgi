...
out=pathlib.Path('/tmp/sqgi-v27-records-probe/candidate');captures={};entries=collections.Counter();returns=collections.Counter();helpers=collections.Counter();breakpoints=[]
