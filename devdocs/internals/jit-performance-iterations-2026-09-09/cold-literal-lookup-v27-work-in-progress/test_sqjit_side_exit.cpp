...
int main()
{
    int failures = generated_literal_addresses() + generated_owning_postincrement() + generated_repeated_receiver() + generated_length_intrinsics() + generated_exits() + generated_exit_sites() + generated_store_release() + generated_integer_comparisons() + generated_cache_proofs() + generated_caches() + generated_scalars() + generated_cached_release() + generated_reference_reads() + generated_copy_release();
#if defined(__aarch64__) && defined(__linux__)
    CHECK(native_test_groups==14,"all fourteen AArch64 generated-code test groups actually execute");
