...
out=pathlib.Path('/tmp/sqgi-v25-self-publication-study/intrinsic-captures/control');captures={};counts=collections.Counter();entries=[]
...
print('INTRINSIC_ROUTE_CAPTURED','control',dict(counts))
end
