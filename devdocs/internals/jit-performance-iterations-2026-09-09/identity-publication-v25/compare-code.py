...
import struct,json
S=Path('/tmp/sqgi-v25-self-publication-study');P=Path('/home/sam/Programming/sqgi/devdocs/internals/jit-performance-iterations-2026-09-09/precise-length-v24/study')
def words(path):
