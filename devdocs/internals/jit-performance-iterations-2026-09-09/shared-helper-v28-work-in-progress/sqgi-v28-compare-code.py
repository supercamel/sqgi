...
import struct,json
S=Path('/tmp/sqgi-shared-helper-study');P=Path('/home/sam/Programming/sqgi/devdocs/internals/jit-performance-iterations-2026-09-09/cold-literal-lookup-v27/study')
def words(path):
...
assert len(old)*4==7884 and len(new)*4==7408 and normalized(old)!=normalized(new),'expected shared tier3 buffer layout'
