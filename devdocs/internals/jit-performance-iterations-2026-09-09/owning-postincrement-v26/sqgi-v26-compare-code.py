...
import struct,json
S=Path('/tmp/sqgi-owning-postincrement-study');P=Path('/home/sam/Programming/sqgi/devdocs/internals/jit-performance-iterations-2026-09-09/identity-publication-v25/study')
def words(path):
