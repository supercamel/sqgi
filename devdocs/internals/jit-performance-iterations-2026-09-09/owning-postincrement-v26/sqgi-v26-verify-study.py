...
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'owning-postincrement-v26';S=Path('/tmp/sqgi-owning-postincrement-study')
h=lambda p:hashlib.sha256(p.read_bytes()).hexdigest()
binary=R/'build-jit-audit-20260909/owning-postincrement-v26/sqgi';sha=h(binary)
assert sha=='80926f469e88e85b0311f03ad81e570b75bb4d7fd4222feb402380f96e970855'
...
code=json.loads((S/'native-code-comparison.json').read_text());assert code['recycle']['after_bytes']==7344 and code['recycle']['before_bytes']==7296
assert all(v['normalized_equal'] for k,v in code.items() if k!='recycle')
