...
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09/local-slot-forwarding-v22';B=R/'build-jit-audit-20260909/local-slot-forwarding-v22';D=Path('/tmp/sqgi-v22-native-profile')
...
{s['stack_load_store_samples']} native sampled IPs are stack load/store instructions.
