...
P=R/'devdocs/internals/jit-performance-iterations-2026-09-09/receiver-entry-guards-v21/profiles'
D=Path('/tmp/sqgi-local-slot-forwarding-study/profiles');result={}
