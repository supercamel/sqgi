...
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'local-slot-forwarding-v22';B=R/'build-jit-audit-20260909/local-slot-forwarding-v22';S=Path('/tmp/sqgi-local-slot-forwarding-study')
...
for glob in ['sqgi-precise-v22-*','sqgi-v22-*.py','sqgi-freeze-v22.py']:
...
print('Archived V22; verified',len(old),'prior hashes. Reports and global manifest pending.')
