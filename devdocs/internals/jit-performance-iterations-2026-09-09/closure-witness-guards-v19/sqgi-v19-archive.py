...
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'closure-witness-guards-v19';B=R/'build-jit-audit-20260909/closure-witness-guards-v19';S=Path('/tmp/sqgi-closure-witness-guard-study')
...
for glob in ['sqgi-precise-v19-*','sqgi-v19-*.py','sqgi-freeze-v19.py']:
...
print('Archived V19; verified',len(old),'prior hashes. Reports and global manifest pending.')
