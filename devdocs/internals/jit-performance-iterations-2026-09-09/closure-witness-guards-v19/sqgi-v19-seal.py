...
import hashlib,json
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'closure-witness-guards-v19';B=R/'build-jit-audit-20260909/closure-witness-guards-v19'
