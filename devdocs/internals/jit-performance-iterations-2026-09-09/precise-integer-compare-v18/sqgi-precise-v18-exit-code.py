...
P=R/'devdocs/internals/jit-performance-iterations-2026-09-09/precise-cache-proofs-v17/profiles'
D=Path('/tmp/sqgi-precise-integer-compare-study/profiles');result={}
