...
R=Path('/home/sam/Programming/sqgi');A=R/'devdocs/internals/jit-performance-iterations-2026-09-09';D=A/'scalar-loop-entry-guards-v20';B=R/'build-jit-audit-20260909/scalar-loop-entry-guards-v20';S=Path('/tmp/sqgi-scalar-entry-guard-study')
...
for glob in ['sqgi-precise-v20-*','sqgi-v20-*.py','sqgi-freeze-v20.py']:
...
print('Archived V20; verified',len(old),'prior hashes. Reports and global manifest pending.')
