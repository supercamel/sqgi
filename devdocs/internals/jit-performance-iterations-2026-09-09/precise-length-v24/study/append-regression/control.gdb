...
out=pathlib.Path('/tmp/sqgi-precise-length-study/append-regression/control.json');ranges=[];bps=[];counts=collections.Counter();offsets=collections.Counter();entries=[];symbols={};captured_pid=0
