...
import struct,json
S=Path('/tmp/sqgi-precise-length-study');P=Path('/home/sam/Programming/sqgi/devdocs/internals/jit-performance-iterations-2026-09-09/transactional-float-copies-v23')
def words(path):
