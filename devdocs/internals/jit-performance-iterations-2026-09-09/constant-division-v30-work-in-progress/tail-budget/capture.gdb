...
out=pathlib.Path('/tmp/sqgi-v30-tail-budget')
...
class Tail(gdb.Breakpoint):
 def stop(self):
  ...
  return False
tail=Tail('/home/sam/Programming/sqgi/Squirrel3/squirrel/jit/sqjit_backend_aarch64_precise.inc:1167',internal=True)
attempt=Attempt('/home/sam/Programming/sqgi/Squirrel3/squirrel/jit/sqjit_backend_aarch64_precise.inc:1061',internal=True)
capture=Capture('/home/sam/Programming/sqgi/Squirrel3/squirrel/jit/sqjit.cpp:610',internal=True)
end
run /tmp/sqgi-v30-tail-budget/functions.nut
python
