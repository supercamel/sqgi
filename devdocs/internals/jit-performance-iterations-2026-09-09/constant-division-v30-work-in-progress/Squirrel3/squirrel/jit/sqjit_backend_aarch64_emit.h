...
// x9 input/result; x10/x11 scratch. Requires a proven positive divisor.
...
// Recorded float-copy pairs use X9 in the input; their caller guarantees X9/D0
...
bool sqjit_a64_forward_local_slots(SQJitA64Buffer *buf, SQInteger slots,
    const SQInteger *float_copies = nullptr, SQInteger nfloat_copies = 0);
