...
SOURCE = ROOT / 'source'
BIN = ROOT / 'baseline/sqgi'
OLD = Path('/tmp/sqgi-compound-baseline-release-20260909.UICRYQ/sqgi')
...
if __name__=='__main__':
    if sys.argv[1]=='timings': timings()
    elif sys.argv[1]=='profiles': profiles()
    elif sys.argv[1]=='targeted': targeted()
    elif sys.argv[1]=='profitability': profitability()
