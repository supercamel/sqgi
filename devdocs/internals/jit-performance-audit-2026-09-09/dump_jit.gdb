...
out = pathlib.Path('/tmp/sqgi-profile-20260909/profiles')
seen = set()
class Capture(gdb.Breakpoint):
    ...
    def stop(self):
        ...
        return False
Capture('/tmp/sqgi-profile-20260909/source/Squirrel3/squirrel/jit/sqjit.cpp:120','frame')
Capture('/tmp/sqgi-profile-20260909/source/Squirrel3/squirrel/jit/sqjit.cpp:445','loop')
end
run
